...
/**
 * insert_dnodeint_at_index - the function that inserts
 *	a new node at a specific position
...
/**
 * add_in_middle - the function that adds a node in between
...
/**
 * add_at_the_end - the function that adds a node at
...
/**
 * create_new_node - the function that creates a new node to be
